...
schema_view = get_schema_view(
   openapi.Info(
      ...
      default_version='v1',
      description="ev.22 Shop market test rest project!",
...
router = SimpleRouter()
router.register('products', views.ProductViewSet)       # product urls path(CRUD)
router.register('categories',CategoryViewSet)         # category list
...
urlpatterns = [
    ...
    path('api/v1/', include(router.urls)),      # for all router urls
